...
<head>
    ...
    <link rel="stylesheet" href="{{ url(asset('asset/css/register.css')) }}">
            ...
            <div class="card mt-5">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="username" class="col-md-4 col-form-label text-md-end">{{ __('اسم المستخدم') }}</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary btn-lg" style="width: 250px;">{{ __('تسجيل') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
