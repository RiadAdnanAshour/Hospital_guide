    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="d-flex justify-content-between align-items-center">
                <h2 class="page-title"><i class="fas fa-layer-group mr-2"></i> قائمة الأقسام</h2>
        ...
        <div class="col-lg-12">
            @can('person-create')
                <div class="d-flex justify-content-end mb-2">
                    <a class="btn btn-add" href="{{ route('dept.create') }}">
            ...
            <table class="table table-bordered">
                ...
                @foreach ($depts as $dep)
                    <tr>
                        ...
                        <td>{{ $dep->Dept_Name }}</td>
                        <td>
                            <form onsubmit="return confirm('هل أنت متأكد من رغبتك في حذف هذا القسم؟')" action="{{ route('dept.destroy', $dep->id) }}" method="POST">
                                @can('person-edit')
                                    <a class="btn btn-action btn-primary" href="{{ route('dept.edit', $dep->id) }}">
